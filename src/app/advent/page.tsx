    ...
    <main className={styles.main}>
      <div className={styles.container}>
        <div className={styles.description}>
          ...
          <p className={styles.subsubtitle}><strong>Pro hledače chystáme i adventní kolekci Berounského rybníčku</strong></p>
          <p className={styles.paragraph}><strong>Termo hrnky</strong> na svařák s víčkem. Kdyby se vám v nápoji čeřila hladina,
            aby nic nevyšplouchlo ani při procházce.</p>
